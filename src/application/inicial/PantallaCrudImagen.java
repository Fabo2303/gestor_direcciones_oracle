...
public class PantallaCrudImagen extends ImagePanel{
	...
	private void initButtonAgregar(){
		...
		buttonAgregar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				myFrame.setContentPane(new PantallaIngresarImagen(myFrame));
				myFrame.revalidate();
			}
		});
		add(buttonAgregar);
	...
	private void initButtonModificar(){
		...
		buttonModificar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				myFrame.setContentPane(new TablaImagen(myFrame));
				myFrame.revalidate();
			}
		});
		add(buttonModificar);
