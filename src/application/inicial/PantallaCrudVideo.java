...
public class PantallaCrudVideo extends ImagePanel{
	...
	private void initButtonAgregar(){
		...
		buttonAgregar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				myFrame.setContentPane(new PantallaIngresarVideo(myFrame));
				myFrame.revalidate();
			}
		});
		add(buttonAgregar);
	...
	private void initButtonModificar(){
		...
		buttonModificar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				myFrame.setContentPane(new TablaVideo(myFrame));
				myFrame.revalidate();
			}
		});
		add(buttonModificar);
