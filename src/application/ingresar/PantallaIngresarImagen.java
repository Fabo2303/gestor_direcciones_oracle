...
public class PantallaIngresarImagen {
	...
	private JTextField nombreField, urlField;
	...
	public PantallaIngresarImagen(JFrame ventana_) {
	...
	private void initTitulo() {
		...
		titulo2Label = new JLabel("IMAGEN");
		titulo2Label.setBounds((int) (titulo1Label.getX() + titulo1Label.getWidth() / 2 - WIDTH * 0.05),
				(int) (titulo1Label.getY() + titulo1Label.getHeight() + HEIGHT * 0.005), (int) (WIDTH * 0.45),
				(int) (HEIGHT * 0.055));
		...
		MouseAdapter actualizarArchivo = new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!nombre.equals("") && !descripcion.equals("") && !url.equals("") && !idProy.equals("")) {
					...
					Imagen v1 = new Imagen(0, nombre, descripcion, Integer.parseInt(idProy), 0, url, 1);
