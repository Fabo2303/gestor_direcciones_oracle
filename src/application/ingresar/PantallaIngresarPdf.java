...
public class PantallaIngresarPdf {
	...
	public PantallaIngresarPdf(JFrame ventana_) {
	...
	private void initTitulo() {
		...
		titulo2Label = new JLabel("ARCHIVO");
		...
		MouseAdapter actualizarArchivo = new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!nombre.equals("") && !descripcion.equals("") && !url.equals("") && !idProy.equals("")) {
					...
					Pdf v1 = new Pdf(0, nombre, descripcion, Integer.parseInt(idProy), 0, url, 1);
	...
	private void initBack() {
		...
		MouseAdapter volver = new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				PantallaCrudPdf pcd = new PantallaCrudPdf(ventana);
			}
		};
	...
	public static void main(String[] args) {
		...
		PantallaIngresarPdf window = new PantallaIngresarPdf(ventana);
	}
}
